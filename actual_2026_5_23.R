...
i2.df = subset(indiv2024_1.df, select = c(id, paypref_inperson, paypref_b1, paypref_web, hhincome, income_hh, age, cc_adopt, chk_adopt, chk_adopt, computer_adopt, csh_adopt, crypto_adopt, dc_adopt, elect_adopt, mb_adopt, mobile_adopt, mobile_inperson_adopt, cc_rewards))
...
# Information provided below Table 1
# num resp
nrow(v4.df)
#
...
# frac who prefer credit who own credit
round(num_ccprefer_ccown/num_ccprefer,2)
# frac who prefer credit don't who own credit
...
# frac who prefer debit who own debit
round(num_dcprefer_dcown/num_dcprefer,2)
# frac who prefer debit don't who own debit
round(num_dcprefer_dcnotown/num_dcprefer,2)

# frac credit owners who prefer credit with rewards
round(num_ccprefer_ccown_reward/num_ccprefer_ccown, 2)
# frac credit owners who prefer credit with no rewards
round(num_ccprefer_ccown_noreward/num_ccprefer_ccown, 2)
# frac credit owners who don't prefer credit with rewards
...
nrow(r4.df[is.na(r4.df$credit_reward), ])#don't impute because it applies to credit only => not used for random forest!
