...
r4_imp_accept_cash = missRanger(data = r4.df, formula = accept_cash ~ amnt + merch)
#
r4_imp_accept_card = missRanger(data = r4.df, formula = accept_card ~ amnt + merch)
#
r4_imp_cc_surcharge = missRanger(data = r4.df, formula = cc_surcharge ~ amnt + merch)
#
r4_imp_discount = missRanger(data = r4.df, formula = discount ~ amnt + merch)
...
r4_imp_accept_cash_train = missRanger(data = r4_train.df, formula = accept_cash ~ amnt + merch)
#
r4_imp_accept_card_train = missRanger(data = r4_train.df, formula = accept_card ~ amnt + merch)
#
r4_imp_cc_surcharge_train = missRanger(data = r4_train.df, formula = cc_surcharge ~ amnt + merch)
#
r4_imp_discount_train = missRanger(data = r4_train.df, formula = discount ~  amnt + merch)
#
...
r4_imp_accept_cash_test = missRanger(data = r4_test.df, formula = accept_cash ~ amnt + merch)
#
r4_imp_accept_card_test = missRanger(data = r4_test.df, formula = accept_card ~ amnt + merch)
#
r4_imp_cc_surcharge_test = missRanger(data = r4_test.df, formula = cc_surcharge ~ amnt + merch)
#
r4_imp_discount_test = missRanger(data = r4_test.df, formula = discount ~  amnt + merch)
#
...
tree_data5.df = tree_data4.df %>% rename("Cash_accepted" = "accept_cash")
tree_data6.df = tree_data5.df %>% rename("Card_accepted" = "accept_card")
names(tree_data4.df)
...
tree1 = rpart(tree_model1, data = tree_data6.df, method = "class", control = rpart.control(cp = 0.001))# Extremely-long tree first, then prune it
...
# Note: Some info in the text are computed at the beginning of RF variable importance table
## Card accepted
# raw accept card
